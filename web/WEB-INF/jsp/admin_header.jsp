...
<nav style="position:fixed;z-index: 999;width: 100%;background-color: #25c6fc" class="navbar navbar-default"
    ...
    <div class="container-fluid">
        <div class="navbar-header" style="margin-left: 8%;margin-right: 1%">
            <a class="navbar-brand" href="admin_books.html" style="font-family: 华文行楷; font-size: 250%; color: white">物流信息管理系统</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="admin_books.html">全部物流信息</a></li>
                        <li class="divider"></li>
                        <li><a href="book_add.html">安排物流</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: white">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="allreaders.html">全部客户</a></li>
                        <li class="divider"></li>
                        <li><a href="reader_add.html">添加客户</a></li>
                    </ul>
                </li>
                <li >
